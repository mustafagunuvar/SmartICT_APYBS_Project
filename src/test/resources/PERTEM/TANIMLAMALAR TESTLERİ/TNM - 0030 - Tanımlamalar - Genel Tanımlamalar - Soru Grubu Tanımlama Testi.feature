Feature: HVL-AZ-PYBS-TMN-YGD-90 Soru Grubu Tanımlamasına olanak sağlayacaktır
  ...
  @scenarious
  Scenario: PERTEM Soru Grubu Tanimlama, Düzenleme, Listeleme ve silme testi
    ...
    Then Uzun Metin alanina "Cografya Soru Grubu-Duzenlendi" girilir ve ardindan Kaydet butonuna tiklanir
    Then Basarili pop-up’ının geldigi ve listede duzenlenen kaydin yer aldigi gorulur
    Then Arama alanindaki Uzun Metin alanina "Cografya Soru Grubu-Duzenlendi" girilir ve Sorgula butonuna tiklanir
